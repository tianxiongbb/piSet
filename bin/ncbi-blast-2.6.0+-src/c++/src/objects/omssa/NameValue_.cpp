...
void CNameValue_Base::ResetName(void)
{
    m_Name.erase();
    m_set_State[0] &= ~0x3;
}

void CNameValue_Base::ResetValue(void)
{
    m_Value.erase();
    m_set_State[0] &= ~0xc;
}

void CNameValue_Base::Reset(void)
{
    ResetName();
    ResetValue();
}

BEGIN_NAMED_BASE_CLASS_INFO("NameValue", CNameValue)
{
...
// constructor
CNameValue_Base::CNameValue_Base(void)
{
