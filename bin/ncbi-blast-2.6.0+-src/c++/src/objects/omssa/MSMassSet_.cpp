...
void CMSMassSet_Base::Reset(void)
{
    ResetMonomass();
    ResetAveragemass();
    ResetN15mass();
...
BEGIN_NAMED_BASE_CLASS_INFO("MSMassSet", CMSMassSet)
{
...
// constructor
CMSMassSet_Base::CMSMassSet_Base(void)
    : m_Monomass(0), m_Averagemass(0), m_N15mass(0)
{
