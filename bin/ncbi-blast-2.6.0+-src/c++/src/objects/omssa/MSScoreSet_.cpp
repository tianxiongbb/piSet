...
void CMSScoreSet_Base::ResetName(void)
{
    m_Name.erase();
    m_set_State[0] &= ~0x3;
}

void CMSScoreSet_Base::Reset(void)
{
    ResetName();
    ResetValue();
}

BEGIN_NAMED_BASE_CLASS_INFO("MSScoreSet", CMSScoreSet)
{
...
// constructor
CMSScoreSet_Base::CMSScoreSet_Base(void)
    : m_Value(0)
{
