...
void CModel_space_points_Base::Reset(void)
{
    ResetScale_factor();
    ResetX();
    ResetY();
...
BEGIN_NAMED_BASE_CLASS_INFO("Model-space-points", CModel_space_points)
{
...
// constructor
CModel_space_points_Base::CModel_space_points_Base(void)
    : m_Scale_factor(0)
{
