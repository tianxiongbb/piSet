...
void CMim_author_Base::ResetName(void)
{
    m_Name.erase();
    m_set_State[0] &= ~0x3;
}

void CMim_author_Base::Reset(void)
{
    ResetName();
    ResetIndex();
}

BEGIN_NAMED_BASE_CLASS_INFO("Mim-author", CMim_author)
{
...
// constructor
CMim_author_Base::CMim_author_Base(void)
    : m_Index(0)
{
