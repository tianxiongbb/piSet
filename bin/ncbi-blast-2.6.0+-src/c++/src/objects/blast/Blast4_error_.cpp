...
void CBlast4_error_Base::ResetMessage(void)
{
    m_Message.erase();
    m_set_State[0] &= ~0xc;
}

void CBlast4_error_Base::Reset(void)
{
    ResetCode();
    ResetMessage();
}

BEGIN_NAMED_BASE_CLASS_INFO("Blast4-error", CBlast4_error)
{
...
// constructor
CBlast4_error_Base::CBlast4_error_Base(void)
    : m_Code(0)
{
