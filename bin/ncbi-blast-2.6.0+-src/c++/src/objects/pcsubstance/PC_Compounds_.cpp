...
BEGIN_NAMED_BASE_IMPLICIT_CLASS_INFO("PC-Compounds", CPC_Compounds)
{
    SET_CLASS_MODULE("NCBI-PCSubstance");
    ADD_NAMED_MEMBER("", m_data, STL_list, (STL_CRef, (CLASS, (CPC_Compound))))->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
