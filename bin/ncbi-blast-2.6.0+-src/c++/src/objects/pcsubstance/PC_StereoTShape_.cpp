...
void CPC_StereoTShape_Base::Reset(void)
{
    ResetCenter();
    ResetTop();
    ResetBottom();
...
BEGIN_NAMED_BASE_CLASS_INFO("PC-StereoTShape", CPC_StereoTShape)
{
...
// constructor
CPC_StereoTShape_Base::CPC_StereoTShape_Base(void)
    : m_Center(0), m_Top(0), m_Bottom(0), m_Above(0)
{
