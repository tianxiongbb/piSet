...
void CHitDescr_Base::Reset(void)
{
    ResetId();
    ResetAccession();
    ResetTitle();
...
BEGIN_NAMED_BASE_CLASS_INFO("HitDescr", CHitDescr)
{
    ...
    ADD_NAMED_STD_MEMBER("sciname", m_Sciname)->SetSetFlag(MEMBER_PTR(m_set_State[0]))->SetOptional();
    info->RandomOrder();
