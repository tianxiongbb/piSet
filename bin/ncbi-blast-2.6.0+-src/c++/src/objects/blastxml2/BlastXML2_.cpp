...
BEGIN_NAMED_BASE_IMPLICIT_CLASS_INFO("BlastXML2", CBlastXML2)
{
    SET_CLASS_MODULE("NCBI-BlastOutput2");
    ADD_NAMED_MEMBER("", m_data, STL_list_set, (STL_CRef, (CLASS, (CBlastOutput2))))->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
