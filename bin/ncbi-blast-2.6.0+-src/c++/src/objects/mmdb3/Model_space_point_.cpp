...
void CModel_space_point_Base::Reset(void)
{
    ResetScale_factor();
    ResetX();
    ResetY();
...
BEGIN_NAMED_BASE_CLASS_INFO("Model-space-point", CModel_space_point)
{
...
// constructor
CModel_space_point_Base::CModel_space_point_Base(void)
    : m_Scale_factor(0), m_X(0), m_Y(0), m_Z(0)
{
