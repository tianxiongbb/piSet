...
BEGIN_NAMED_BASE_IMPLICIT_CLASS_INFO("ID2-Params", CID2_Params)
{
    SET_CLASS_MODULE("NCBI-ID2Access");
    ADD_NAMED_MEMBER("", m_data, STL_list, (STL_CRef, (CLASS, (CID2_Param))))->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
