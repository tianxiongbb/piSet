...
void CLocation_interval_Base::Reset(void)
{
    ResetFrom();
    ResetTo();
}

BEGIN_NAMED_BASE_CLASS_INFO("Location-interval", CLocation_interval)
{
...
// constructor
CLocation_interval_Base::CLocation_interval_Base(void)
    : m_From(0), m_To(0)
{
