...
BEGIN_NAMED_BASE_CLASS_INFO("SeqEdit-Cmd-AddId", CSeqEdit_Cmd_AddId)
{
    SET_CLASS_MODULE("NCBI-SeqEdit");
    ADD_NAMED_REF_MEMBER("id", m_Id, CSeqEdit_Id);
    ADD_NAMED_REF_MEMBER("add-id", m_Add_id, CSeq_id);
    info->RandomOrder();
