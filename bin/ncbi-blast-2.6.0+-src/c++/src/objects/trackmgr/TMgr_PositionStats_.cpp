...
void CTMgr_PositionStats_Base::Reset(void)
{
    ResetMin();
    ResetMax();
}

BEGIN_NAMED_BASE_CLASS_INFO("TMgr-PositionStats", CTMgr_PositionStats)
{
...
// constructor
CTMgr_PositionStats_Base::CTMgr_PositionStats_Base(void)
    : m_Min(0), m_Max(0)
{
