...
BEGIN_NAMED_BASE_CLASS_INFO("ID2S-Seq-id-Interval", CID2S_Seq_id_Interval)
{
    ...
    ADD_NAMED_STD_MEMBER("length", m_Length)->SetDefault(new TLength(1))->SetSetFlag(MEMBER_PTR(m_set_State[0]))->SetOptional();
    info->RandomOrder();
