...
BEGIN_NAMED_BASE_CLASS_INFO("ID2S-Chunk", CID2S_Chunk)
{
    SET_CLASS_MODULE("NCBI-Seq-split");
    ADD_NAMED_MEMBER("data", m_Data, STL_list_set, (STL_CRef, (CLASS, (CID2S_Chunk_Data))))->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
