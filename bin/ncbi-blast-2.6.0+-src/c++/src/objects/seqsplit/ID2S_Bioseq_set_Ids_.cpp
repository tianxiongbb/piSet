...
BEGIN_NAMED_BASE_IMPLICIT_CLASS_INFO("ID2S-Bioseq-set-Ids", CID2S_Bioseq_set_Ids)
{
    SET_CLASS_MODULE("NCBI-Seq-split");
    ADD_NAMED_MEMBER("", m_data, STL_list_set, (STD, (int)))->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
