remap__.o remap__.d : \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/remap/remap__.cpp) \
 $(wildcard /usr/include/stdc-predef.h) \
 $(wildcard $(includedir)/ncbi_pch.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/remap/RMReply.cpp) \
 ...
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/remap/RMRequest.cpp) \
 $(wildcard $(includedir)/objects/remap/RMRequest.hpp) \
 $(wildcard $(includedir)/objects/remap/RMRequest_.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/remap/Remap_db_id.cpp) \
 $(wildcard $(includedir)/objects/remap/Remap_db_id.hpp) \
 $(wildcard $(includedir)/objects/remap/Remap_db_id_.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/remap/Remap_dt.cpp) \
 $(wildcard $(includedir)/objects/remap/Remap_dt.hpp) \
 $(wildcard $(includedir)/objects/remap/Remap_dt_.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/remap/Remap_query.cpp) \
 $(wildcard $(includedir)/objects/remap/Remap_query.hpp) \
 $(wildcard $(includedir)/objects/remap/Remap_query_.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/remap/Remap_reply.cpp) \
 $(wildcard $(includedir)/objects/remap/Remap_reply.hpp) \
 $(wildcard $(includedir)/objects/remap/Remap_reply_.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/remap/Remap_request.cpp) \
 $(wildcard $(includedir)/objects/remap/Remap_request.hpp) \
 $(wildcard $(includedir)/objects/remap/Remap_request_.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/remap/Remap_result.cpp) \
