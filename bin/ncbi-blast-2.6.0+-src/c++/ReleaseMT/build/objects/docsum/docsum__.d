docsum__.o docsum__.d : \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/docsum/docsum__.cpp) \
 $(wildcard /usr/include/stdc-predef.h) \
 $(wildcard $(includedir)/ncbi_pch.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/docsum/Assay.cpp) \
 ...
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/docsum/Assembly.cpp) \
 $(wildcard $(includedir)/objects/docsum/Assembly.hpp) \
 $(wildcard $(includedir)/objects/docsum/Assembly_.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/docsum/BaseURL.cpp) \
 $(wildcard $(includedir)/objects/docsum/BaseURL.hpp) \
 $(wildcard $(includedir)/objects/docsum/BaseURL_.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/docsum/Component.cpp) \
 $(wildcard $(includedir)/objects/docsum/Component.hpp) \
 $(wildcard $(includedir)/objects/docsum/Component_.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/docsum/ExchangeSet.cpp) \
 $(wildcard $(includedir)/objects/docsum/ExchangeSet.hpp) \
 $(wildcard $(includedir)/objects/docsum/ExchangeSet_.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/docsum/FxnSet.cpp) \
 $(wildcard $(includedir)/objects/docsum/FxnSet.hpp) \
 $(wildcard $(includedir)/objects/docsum/FxnSet_.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/docsum/MapLoc.cpp) \
 $(wildcard $(includedir)/objects/docsum/MapLoc.hpp) \
 $(wildcard $(includedir)/objects/docsum/MapLoc_.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/docsum/PrimarySequence.cpp) \
 $(wildcard $(includedir)/objects/docsum/PrimarySequence.hpp) \
 $(wildcard $(includedir)/objects/docsum/PrimarySequence_.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/docsum/Rs.cpp) \
 $(wildcard $(includedir)/objects/docsum/Rs.hpp) \
 $(wildcard $(includedir)/objects/docsum/Rs_.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/docsum/RsLinkout.cpp) \
 $(wildcard $(includedir)/objects/docsum/RsLinkout.hpp) \
 $(wildcard $(includedir)/objects/docsum/RsLinkout_.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/docsum/RsStruct.cpp) \
 $(wildcard $(includedir)/objects/docsum/RsStruct.hpp) \
 $(wildcard $(includedir)/objects/docsum/RsStruct_.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/objects/docsum/Ss.cpp) \
