msvc_project_context.o msvc_project_context.d : \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/msvc_project_context.cpp) \
 $(wildcard /usr/include/stdc-predef.h) \
 $(wildcard $(includedir)/ncbi_pch.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/stl_msvc_usage.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/msvc_project_context.hpp) \
 $(wildcard /usr/include/c++/5/list) $(wildcard /usr/include/c++/5/bits/stl_algobase.h) \
 ...
 $(wildcard /usr/include/c++/5/initializer_list) $(wildcard /usr/include/c++/5/bits/stl_list.h) \
 $(wildcard /usr/include/c++/5/bits/list.tcc) $(wildcard /usr/include/c++/5/string) \
 $(wildcard /usr/include/c++/5/bits/stringfwd.h) \
 $(wildcard /usr/include/c++/5/bits/char_traits.h) $(wildcard /usr/include/c++/5/bits/postypes.h) \
 ...
 $(wildcard /usr/include/c++/5/cstdint) \
 ...
 $(wildcard /usr/include/c++/5/bits/basic_string.tcc) $(wildcard /usr/include/c++/5/map) \
 $(wildcard /usr/include/c++/5/bits/stl_tree.h) \
 $(wildcard /usr/include/c++/5/ext/aligned_buffer.h) \
 $(wildcard /usr/include/c++/5/bits/stl_map.h) $(wildcard /usr/include/c++/5/tuple) \
 ...
 $(wildcard /usr/include/c++/5/bits/stl_multimap.h) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/proj_item.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/msvc_prj_utils.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/ptb_registry.hpp) \
 ...
 $(wildcard /usr/include/c++/5/algorithm) $(wildcard /usr/include/c++/5/bits/stl_algo.h) \
 ...
 $(wildcard /usr/include/c++/5/bits/unique_ptr.h) \
 ...
 $(wildcard /usr/include/c++/5/memory) $(wildcard /usr/include/c++/5/bits/stl_raw_storage_iter.h) \
 ...
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/proj_datatool_generated_src.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/file_contents.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/proj_utils.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/msvc_makefile.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/proj_builder_app.hpp) \
 ...
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/resolver.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/msvc_site.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/msvc_dlls_info.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/proj_tree.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/proj_tree_builder.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/msvc_tools_implement.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/msvc_traits.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/msvc_prj_defines.hpp) \
 $(wildcard /data/tusers/yutianx/tongji2/Software/ncbi-blast-2.6.0+-src/c++/src/build-system/project_tree_builder/ptb_err_codes.hpp)
